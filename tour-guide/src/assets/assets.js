...
export const ownerMenuLinks = [
    ...
    { name: "Add Packages", path: "/owner/add-packages", icon: addIcon, coloredIcon: addIconColored },
    { name: "Manage Packages", path: "/owner/manage-packages", icon: carIcon, coloredIcon: carIconColored },
